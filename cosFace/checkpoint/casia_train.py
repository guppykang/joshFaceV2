...
parser.add_argument('--imageRoot', default='/home/joshuakang/datasets/CASIA-WebFace', help='path to input images')
parser.add_argument('--alignmentRoot', default='./data/casia_landmarkMTCNN.txt', help='path to the alignment file')
...
net = faceNet.faceNet_BN(classnum=10576, m = opt.marginFactor, feature = False )
...
print('Initializing the dataset loader')
